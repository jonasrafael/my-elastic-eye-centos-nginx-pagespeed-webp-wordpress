...
In the SSH on your VM Instance, enjoy with the tutorial:
...
# Add Nginx Repository - To Get New Updates;
...
# Add Maria Repository - To Get New Updates;
...
# And now we going tho the recompile the Nginx with PageSpeed Mod
